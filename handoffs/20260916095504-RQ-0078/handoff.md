...
- db/migrations/047_varlik_sinifi_adlari.sql
- db/migrations/048_hisse_kodu_birlestir.sql
- db/sync.sh
- db/watchlist.txt
...
- requirements/RQ-0071-fintables-tamamen-kaldirilsin-kalan-veriler-kap-ve-tefas-tan-alinsin.md
- requirements/RQ-0072-hisse-kodlari-birlestirilsin-gunluk-hisse-fiyatlari-yeni-kaynaktan-gelsin.md
- requirements/RQ-0073-fiyatin-tarihi-tefas-tan-alinsin-getiri-gunu-kutusu-degerlerin-ne-zaman-gelecegini-soylesin.md
- requirements/RQ-0074-yeni-fon-eklemede-kap-adimi-sunucuda-calissin-kosum-bosuna-failed-olmasin.md
- requirements/RQ-0075-tefas-a-gereksiz-istek-atilmasin-verisi-olan-fon-atlansin.md
- requirements/RQ-0076-tefas-toplu-uclarina-gecilsin-gunde-iki-istek-tarih-kaynaktan-dagilim-pdf-siz.md
- requirements/RQ-0077-yeni-fon-eklenince-fiyatlar-en-eski-alis-tarihinden-geriye-cekilsin.md
- requirements/RQ-0078-portfoyum-de-bugun-cikilan-fonlar-rozetle-ve-bugunku-kazanciyla-gorunsun.md
- scripts/_etiket.ts
- scripts/dev-up.sh
...
- src/sources/hisse-fiyat.ts
- src/sources/kap-parse.ts
- src/sources/kap.ts
- src/sources/tefas-dagilim.ts
...
- tests/tefas-dagilim.test.ts
- tests/tefas-net-akis.test.ts
- tests/tefas-pencere.test.ts
- tests/tefas-source.test.sh
- tests/tefas-toplu.test.ts
- tests/test-hygiene.test.sh
- tests/today-exits.test.sh
