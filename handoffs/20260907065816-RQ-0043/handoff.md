...
İki sekme, üç değil. Şikâyeti çözen tek şey aynı-pencere sıralaması ve bir
tane yeterli; 3 aylık getiri Portföyüm tablosunda fon başına zaten duruyor.

"En çok kaybettiren fonlarım" paneli de aynı sekmeyi izler: yan yana duran
iki panel farklı ölçütle sıralanırsa birbiriyle çelişir.
...
- "En çok kaybettiren fonlarım" aynı sekmeyi izler.
