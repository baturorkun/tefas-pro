...
**Satır işareti.** Bekleyen alımı olan satırın başında bir işaret durur;
...
- Bekleyen alım varken Portföyüm'de kaç alım beklediğini ve tarihini söyleyen
  bir kutu görünür; yokken kutu çizilmez.
- Bekleyen alımı olan satır bunu bir işaretle belli eder.
