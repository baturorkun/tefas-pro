...
Tarih hesabı takvim günü değil iş günü, ve tatil takvimi hesaba katılır —
uygulamada zaten `settlementFromOrder` bunu yapıyor ve işlem formu aynı
hesabı kullanıyor. İki yerde iki farklı tarih çıkmamalı.
...
- Tarih, satış tarihine fonun satış valörü kadar İŞ GÜNÜ eklenerek bulunur.
- Tatil takvimi hesaba katılır; işlem formuyla aynı hesap kullanılır.
